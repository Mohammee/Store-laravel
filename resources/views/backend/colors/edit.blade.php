                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="card">
                            <div class="card-body p-0">
                                <form class="p-4" action="{{ route('admin.colors.update' , $color->id) }}"
                                      method="POST">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" placeholder="Color Code" id="code" name="code" class="form-control"
                                                   required="" value="{{ old('code' , $color->code) }}">
                                        </div>
                                    </div>
