    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">
                  <span
                      class="user-name text-bold-700">{{ ucwords(auth('admin')->user()->name) }}</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px; object-fit: cover;" src="{{ auth('admin')->user()->avatar ? url(auth('admin')->user()->avatar) :'' }}" alt="avatar"><i></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('admin.admins.profile')}}">
                                <i class="ft-user"></i>
                                    تعديل الملف الشحصي
                            </a>
